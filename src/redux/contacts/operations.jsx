...
// axios.defaults.baseURL = "https://63fbcc576deb8bdb814acd75.mockapi.io";
...
export const update = createAsyncThunk("contacts/updateContact", async ({id, name, number }, thunkAPI) => {
    try {
